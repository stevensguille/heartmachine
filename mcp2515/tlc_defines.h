/*  Copyright (c) 2009 by Alex Leone <acleone ~AT~ gmail.com>
    ...
    modifications:
    * this file used to be at pinouts/atmega_xx8.h
    * renamed the guard
*/

#ifndef _TLC_DEFINES_H_
#define _TLC_DEFINES_H_
...
#define TLC_INIT_CS()    CSTLC_DDR  |= _BV(CSTLC_PIN)
#define TLC_UNSELECT()   CSTLC_PORT &= ~_BV(CSTLC_PIN)
#define TLC_SELECT()     CSTLC_PORT |= _BV(CSTLC_PIN)
