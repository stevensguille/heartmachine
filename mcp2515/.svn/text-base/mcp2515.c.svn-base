...
// ---
uint8_t mcp2515_init(const uint8_t canSpeed, uint16_t id)
{
	uint8_t res;
	...
	if ( res == MCP2515_OK ) {
	    ...
	    mcp2515_write_can_id(MCP_RXF0SIDH, 0, id); //       AND standard
...
void mcp2515_dumpExtendedStatus(void)
{
	...
	printf("MCP Error Flag = 0x%x", eflg);
