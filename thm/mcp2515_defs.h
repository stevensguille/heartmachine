...
// In RXnBF
#define MCP_RXB_B0BFM       0x01    // Pin Operation Mode Bit
#define MCP_RXB_B1BFM       0x02    // 0:DIO 1:Interrupt 
#define MCP_RXB_B0BFE       0x04    // Pin Function Enable Bit 
#define MCP_RXB_B1BFE       0x08    // 0:HiZ 1:defined by B0BFM 
#define MCP_RXB_B0BFS       0x10    // State of RX0BF Pin (can write in DIO MODE)
#define MCP_RXB_B1BFS       0x20    // State of RX0BF Pin (can write in DIO MODE)
...
#define MCP_BFPCTRL     0x0C        // Control the Recieve buffer pins
